...
class Factureretourventes extends StatefulWidget {
  const Factureretourventes({super.key});

  @override
  State<Factureretourventes> createState() => _FactureretourventesState();
}

class _FactureretourventesState extends State<Factureretourventes> {
        ...
        body: SingleChildScrollView(
          ...
          Consumer<InvoiceProvider>(
            builder: (context, invoiceProvider, child) {
              if (invoiceProvider.invoicesretourVente.isEmpty) {
                return Center(child: Text('No invoices yet'));
              }
              return ListView.builder(
                shrinkWrap: true,
                physics: NeverScrollableScrollPhysics(),
                itemCount: invoiceProvider.invoicesretourVente.length,
                itemBuilder: (context, index) {
                  final invoice = invoiceProvider.invoicesretourVente[index];
                  return ListTile(
