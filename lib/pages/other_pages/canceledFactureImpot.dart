...
class Canceledfactureimpot extends StatefulWidget {
  const Canceledfactureimpot({super.key});

  @override
  State<Canceledfactureimpot> createState() => _CanceledfactureimpotState();
}

class _CanceledfactureimpotState extends State<Canceledfactureimpot> {
  @override
        ...
        body: SingleChildScrollView(
          ...
          Consumer<InvoiceProvider>(
            builder: (context, invoiceProvider, child) {
              if (invoiceProvider.canceledInvoicesfacture.isEmpty) {
                return Center(child: Text('Aucune facture annulée'));
              }
              return ListView.builder(
                shrinkWrap: true,
                physics: NeverScrollableScrollPhysics(),
                itemCount: invoiceProvider.canceledInvoicesfacture.length,
                itemBuilder: (context, index) {
                  final invoice =
                      invoiceProvider.canceledInvoicesfacture[index];
                  return ListTile(
