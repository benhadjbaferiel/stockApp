...
import 'package:stock_dz_app/pages/other_pages/page_Vente_Impot.dart';
...
class ShowClientImpot extends StatefulWidget {
  const ShowClientImpot({super.key});

  @override
  State<ShowClientImpot> createState() => _ShowClientImpotState();
}

class _ShowClientImpotState extends State<ShowClientImpot> {
