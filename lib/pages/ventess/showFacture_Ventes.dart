...
class showFactureVente extends StatefulWidget {
  final String label;

  const showFactureVente({required this.label, super.key});

  @override
  State<showFactureVente> createState() => _showFactureVenteState();
}

class _showFactureVenteState extends State<showFactureVente> {
          ...
          Consumer<InvoiceProvider>(
            builder: (context, invoiceProvider, child) {
              ...
              return ListView.builder(
                ...
                itemCount: invoiceProvider.invoicesventes.length,
                itemBuilder: (context, index) {
                  final invoice = invoiceProvider.invoicesventes[index];
                  return ListTile(
