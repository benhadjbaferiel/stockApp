...
class Ventes extends StatefulWidget {
  final String label;
  Ventes({required this.label, super.key});
...
class _VentesState extends State<Ventes> {
  ...
  void _saveInvoice() {
    ...
    invoiceProvider.addInvoiceV(newInvoice);
  ...
  void _saveCanceledInvoice() {
    ...
    invoiceProvider.addInvoiceCancledV(canceledInvoice);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Container(
        ...
        child: Column(
          children: [
            Text('${totalProvider.total}', style: TextStyle(fontSize: 20)),
          ],
        ),
      ),
    ])));
